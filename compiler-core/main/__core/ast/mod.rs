...
use crate::compiler::{ExpressionPosition, Located, Target, module_erlang_name};
use crate::exhaustiveness::CompiledCase;
use crate::parse::{LiteralFloatValue, SpannedString};
use crate::type_::bit_array_options;
    ...
    pub fn find_node(&self, byte_index: u32) -> Option<Located<'_>> {
            ...
            .find(|unqualified_value| unqualified_value.location.contains(byte_index))
        {
            return Some(Located::UnqualifiedImport(
                crate::compiler::UnqualifiedImport {
...
where
    TypedValue: HasType + HasLocation + Clone + bit_array_options::GetLiteralValue,
{
