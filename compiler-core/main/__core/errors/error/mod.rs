...
use crate::bit_array_options::UnsupportedOption;
use crate::compiler::{Origin, Outcome, Runtime, Target};
...
use crate::{bit_array_options, diagnostic::Level, type_::UnifyErrorSituation};
use ecow::EcoString;
...
function and try again.",
                    ...
                    TypeError::BitArraySegmentError { error, location } => {
                        let (label, mut extra) = match error {
                            bit_array_options::ErrorType::ConflictingTypeOptions {
                                existing_type,
                            } => (
                            ...
                            bit_array_options::ErrorType::ConflictingSignednessOptions {
                                existing_signed,
                            } => (
...
signedness of {existing_signed}."
                            ...
                            bit_array_options::ErrorType::ConflictingEndiannessOptions {
                                existing_endianness,
                            } => (
...
are sized based on their value and cannot have a unit."
                            ...
                            bit_array_options::ErrorType::VariableUtfSegmentInPattern => (
...
utf32  must be an exact string.",
                            ...
                            bit_array_options::ErrorType::SegmentMustHaveSize => (
...
a size are only allowed at the end of a bin pattern.",
                            ...
                            bit_array_options::ErrorType::UnitMustHaveSize => (
                            ...
                            bit_array_options::ErrorType::ConstantSizeNotPositive => {
                                ("A constant size must be a positive number", vec![])
                            }
                            bit_array_options::ErrorType::OptionNotSupportedForTarget {
                                target,
