...
use crate::compiler::package_compiler::StdlibPackage;
...
//
// TWEAKED
pub const PRELUDE: &str = crate::template_str!("prelude.mjs");
pub const PRELUDE_TS_DEF: &str = crate::template_str!("prelude.d.mts");
...
impl<'a> Generator<'a> {
    ...
    fn echo_definition(&mut self, imports: &mut Imports<'a>) -> Document<'a> {
        ...
        docvec![line(), crate::template_str!("echo.mjs"), line()]
    }
